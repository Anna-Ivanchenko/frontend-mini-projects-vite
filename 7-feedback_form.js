import"./assets/modulepreload-polyfill-B5Qt9EMX.js";/* empty css                      */import{t as m}from"./assets/vendor-C0lvKic3.js";const o="feedback-form-state";function r(t,e){const n=JSON.stringify(e);localStorage.setItem(t,n)}function c(t,e){const n=localStorage.getItem(t);try{return JSON.parse(n)??e}catch{return n??e}}//! видалення через функцію
